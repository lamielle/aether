...
from ILDModule import ILDModule
...
class CalibrateModule(ILDModule):
...
if '__main__'==__name__:
  from ILDModule import TestILDModule
  from ILDDriver import ILDDriver
  from DiffProvider import DiffProvider
  driver=ILDDriver(640,DiffProvider())
