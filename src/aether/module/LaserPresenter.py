'''
This is a presentation module based on the Impressive Python presentation script.

It displays a set of images or PDFs and allows the user to draw on the screen with a laser pointer.
