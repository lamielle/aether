...
class LaserPointerSaviorChain(AetherTransformChain):
	...
	transform_deps={'laser':('perspective',),
	                #'laser':('thresh2pg','red2pg','camera',),
	                #'thresh2pg':('thresh',),
	                #'red2pg':('ext_red',),
	                #'camera':('bgr2rgb',),
	                #'thresh':('ext_red',),
	...
	transform_settings={'thresh':{'channels':[0],'thresholds':[176,0,0,0]},'bgr2rgb':{'num_channels':3,'convert_method':4},'ext_red':{'channels':[0]}}
#bgr2rgb:
  #num_channels: 3
