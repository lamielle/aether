...
class ShadowPolyChain(AetherTransformChain):
	...
	transforms={'camera':'CVMatPyGameSurface','cv_camera':'CVCamera','bgr2gray':'CVTColor','perspective':'CVPerspective','threshold':'CVThreshold','shadow':'ShadowPolys','invert':'CVInvert'}

	#Dependences from transform to transform, referenced by names defined in the 'transforms' field
	transform_deps={'shadow':('threshold',),'threshold':('invert',),'invert':('perspective',),'perspective':('bgr2gray',),'bgr2gray':('cv_camera',)}
